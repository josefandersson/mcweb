const MinecraftIDs = {
    numberToString: num => MinecraftIDs.nid2sid[num],
    stringToNumber: str => MinecraftIDs.sid2nid[str],
    existsStringToNumber: str => MinecraftIDs.sid2nid[str] != null,
    "nid2sid": {
        "0": "minecraft:air",
        "1": "minecraft:stone",
        "2": "minecraft:grass",
